...
componentDidMount: function(){
        ...
        */
//var svgContainer = document.getElementById("particlePathWrapper");
var svgContainer = this.
//var ns = "http://www.w3.org/2000/svg";
var x = svgContainer.DOCUMENT_NODE;
var svg = svgContainer.getElementsByTagName("path");
...
function moveStar() {
  ...
  stars[0].setAttribute(
    "transform",
    "translate(" +
      (svg[0].getPointAtLength(counter * curveLength).x - 15) +
      "," +
      (svg[0].getPointAtLength(counter * curveLength).y - 15) +
      ")"
  );
  /*
  stars[1].setAttribute(
    "transform",
    "translate(" +
      (svg[1].getPointAtLength(counter * curveLength).x - 15) +
      "," +
      (svg[1].getPointAtLength(counter * curveLength).y - 15) +
      ")"
  );
  */
...
componentDidMount: function(){
      ...
      */
  //var svgContainer = document.getElementById("particlePathWrapper");
  var svgContainer = this.refs.particlePathWrapper;
  svgContainer.style.transform = "scale(4.5)";
  //var ns = "http://www.w3.org/2000/svg";
  // var x = svgContainer.DOCUMENT_NODE;
  //var svg = this.refs.path1;
